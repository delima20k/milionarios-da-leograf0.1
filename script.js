...
// Lista fixa dos 24 concursos das teimosinhas
const teimosinhaConcursos = [
    { numero: 1, data: '29/10/2025', dia: 'Quarta-feira', concurso: 3525 },
    { numero: 2, data: '30/10/2025', dia: 'Quinta-feira', concurso: 3526 },
    { numero: 3, data: '31/10/2025', dia: 'Sexta-feira', concurso: 3527 },
    { numero: 4, data: '01/11/2025', dia: 'Sábado', concurso: 3528 },
    { numero: 5, data: '03/11/2025', dia: 'Segunda-feira', concurso: 3529 },
    { numero: 6, data: '04/11/2025', dia: 'Terça-feira', concurso: 3530 },
    { numero: 7, data: '05/11/2025', dia: 'Quarta-feira', concurso: 3531 },
    { numero: 8, data: '06/11/2025', dia: 'Quinta-feira', concurso: 3532 },
    { numero: 9, data: '07/11/2025', dia: 'Sexta-feira', concurso: 3533 },
    { numero: 10, data: '08/11/2025', dia: 'Sábado', concurso: 3534 },
    { numero: 11, data: '10/11/2025', dia: 'Segunda-feira', concurso: 3535 },
    { numero: 12, data: '11/11/2025', dia: 'Terça-feira', concurso: 3536 },
    { numero: 13, data: '12/11/2025', dia: 'Quarta-feira', concurso: 3537 },
    { numero: 14, data: '13/11/2025', dia: 'Quinta-feira', concurso: 3538 },
    { numero: 15, data: '14/11/2025', dia: 'Sexta-feira', concurso: 3539 },
    { numero: 16, data: '15/11/2025', dia: 'Sábado', concurso: 3540 },
    { numero: 17, data: '17/11/2025', dia: 'Segunda-feira', concurso: 3541 },
    { numero: 18, data: '18/11/2025', dia: 'Terça-feira', concurso: 3542 },
    { numero: 19, data: '19/11/2025', dia: 'Quarta-feira', concurso: 3543 },
    { numero: 20, data: '20/11/2025', dia: 'Quinta-feira', concurso: 3544 },
    { numero: 21, data: '21/11/2025', dia: 'Sexta-feira', concurso: 3545 },
    { numero: 22, data: '22/11/2025', dia: 'Sábado', concurso: 3546 },
    { numero: 23, data: '24/11/2025', dia: 'Segunda-feira', concurso: 3547 },
    { numero: 24, data: '25/11/2025', dia: 'Terça-feira', concurso: 3548 }
];
...
function gerar24BotoesTeimosinha() {
    ...
    // Data atual para comparação (03/11/2025)
    const dataAtual = new Date('2025-11-03');
    ...
    teimosinhaConcursos.forEach((teimosinha) => {
        ...
        const dataConcurso = new Date(teimosinha.data.split('/').reverse().join('-'));
...
async function verificarJogosDoConursoTeimosinha(concursoResultado) {
    ...
    // Verificar cada um dos 10 jogos
    jogos.forEach((jogo, indexJogo) => {
...
// Criar dado simulado para um dia específico
function criarDadoSimuladoParaDia(diaInfo) {
    console.log(`🎭 Criando dados simulados para ${diaInfo.concurso}...`);
    ...
    return {
        ...
        numerosSorteados: numerosSorteados,
        dados: {
            numero: diaInfo.concurso,
            dataApuracao: diaInfo.data,
            valorEstimadoProximoConcurso: 1500000,
            listaDezenas: numerosSorteados.map(n => n.toString().padStart(2, '0')),
            listaRateioPremio: [
                { faixa: 1, numeroDeGanhadores: 0, valorPremio: 0 }, // 15 pontos
