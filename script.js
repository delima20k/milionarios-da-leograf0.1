...
const JogoPaciencia = {
    ...
    // Naipes e valores
    NAIPES: [
        { nome: 'trevo', simbolo: '🍀', cor: 'trevo' },
        { nome: 'ouro', simbolo: '💎', cor: 'vermelha' },
        { nome: 'copas', simbolo: '❤️', cor: 'vermelha' },
        { nome: 'espadas', simbolo: '♠️', cor: 'preta' }
    ],
    ...
    corDiferente(carta1, carta2) {
        ...
        if (cor1 === 'trevo') return cor2 === 'vermelha';
        if (cor1 === 'vermelha') return cor2 === 'preta' || cor2 === 'trevo';
        if (cor1 === 'preta') return cor2 === 'vermelha';
